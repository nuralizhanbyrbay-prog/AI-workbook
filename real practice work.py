...
# ==========================================
# 2. ОЧИСТКА ДАННЫХ (CLEANING)
# ==========================================
# Удаляем 1% экстремальных выбросов для стабильности модели
...
# ==========================================
# 4. ЛИНЕЙНАЯ РЕГРЕССИЯ (HANDMADE NUMPY)
# ==========================================
...
forest_model.fit(X_train, y_train.ravel()) # .ravel() превращает столбец в массив
